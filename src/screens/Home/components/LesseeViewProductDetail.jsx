                ...
                <ScrollView>
                    ...
                    >
                        ...
                        >
                            ...
                            <Text fontSize={16} fontWeight='semibold' marginBottom={7.5}>Ảnh/Video sản phẩm</Text>
                            <Flex
                                flexDirection='row'
                                flexWrap='wrap'
                                style={{columnGap: 15}}
                        ...
                        <GradientButton onPress={() => navigation.navigate('Thanh toán')} radius={10} fontSize={18} text='Bắt đầu thuê' height={55} colors={['#9F3553', '#E98EA6']}/>
                    </Stack>
                </ScrollView>
            </Box>
        </Animated.View>
